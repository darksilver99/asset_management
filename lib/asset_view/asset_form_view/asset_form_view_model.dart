...
import 'asset_form_view_widget.dart' show AssetFormViewWidget;
...
class AssetFormViewModel extends FlutterFlowModel<AssetFormViewWidget> {
  ...
  // Stores action output result for [Backend Call - Read Document] action in AssetFormView widget.
