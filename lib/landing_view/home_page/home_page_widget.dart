                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: FutureBuilder<int>(
                                future: queryAssetListRecordCount(
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: FutureBuilder<int>(
                                future: queryAssetListRecordCount(
                                  parent: FFAppState().customerData.customerRef,
                                  queryBuilder: (assetListRecord) =>
                                      assetListRecord.where(
                                    'status',
                                    isEqualTo: 'ใช้งานอยู่',
                                  ),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                    ...
                                    if (_model.assetResult != null) {
                                      context.pushNamed(
                                        ...
                                        extra: <String, dynamic>{
                                          'assetDocument': _model.assetResult,
                                        },
                                      );
                                    } else {
                                      await showDialog(
                                          ...
                                          return Dialog(
                                            ...
                                            child: WebViewAware(
                                              child: InfoCustomViewWidget(
                                                ...
                                                status: 'error',
                                                detail:
                                                    'ข้อมูล QR Code ไม่ถูกต้องกรุณาตรวจสอบ QR Code ว่าชำรุดหรือไม่ ท่านสามารถตรวจเช็ดอุปกรณ์ได้โดยตรงผ่านการค้นหาที่เมนู \"อุปกรณ์\" > เลือกรายการอุปกรณ์',
                                              ),
                                            ),
                                          );
                                        },
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Column(
                                    ...
                                    children: List.generate(
                                        columnTransactionListRecordList.length,
                                        (columnIndex) {
